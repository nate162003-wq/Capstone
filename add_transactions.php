...
for ($i = 0; $i < 5; $i++) {
    DB::table('bookings')->insert([
        ...
        'contact_phone' => '0912345678' . rand(0, 9),
...
foreach ($bookings as $booking) {
    ...
    DB::table('payments')->insert([
        ...
        'payment_method' => ['gcash', 'bank_transfer', 'cash', 'paymaya'][rand(0, 3)],
    ...
    if (rand(1, 10) > 3) {
        DB::table('payments')->insert([
            ...
            'transaction_reference' => 'TXN' . strtoupper(uniqid()),
            'verified_by' => 2,
            'verified_at' => now()->subDays(rand(0, 5)),
            'notes' => 'Final payment',
            'created_at' => now(),
            'updated_at' => now(),
        ]);
...
echo "Created {$count} payment transactions!\n";
echo "Done!\n";
